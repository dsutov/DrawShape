...
public class ColorClicking extends JFrame {
    ...
    class ColorCanvas extends JPanel implements MouseListener
    {
        ...
        private Rectangle2D rect1 = new Rectangle2D.Double();
        private Rectangle2D square1 = new Rectangle2D.Double();
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            int randNum = (int) Math.random() * shapes.size();

            if(randNum == 0)
            {
                shapes.add(rect1 = new Rectangle2D.Double(e.getX(), e.getY(), 50,70));
            } else if (randNum == 1) {
                shapes.add(square1 = new Rectangle2D.Double(e.getX(), e.getY(), 50, 50));
            }
